...
const NewClassroomModal = (props) => {
  const { newClassroomModalVisible, handleNewClassroomCancelModal } = props;
  const { createLoading, dispatch } = props;
...
export default connect(({ loading }) => ({
  createLoading: loading.effects['teacherClassroom/createClassHour'],
}))(NewClassroomModal);
